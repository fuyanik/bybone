...
import AddCollection from "./addCollections.js";
...
const FincanlarTabaklar = () => {
  ...
  useEffect(() => {
     const articleRef = collection(db, "fincantabak");
    ...
    return (
      ...
      <Navbar/>
        ...
        <AddCollection/>
     <CollectionsHeader  title={"Fincanlar ve Tabaklar"} />  
...
export default FincanlarTabaklar;